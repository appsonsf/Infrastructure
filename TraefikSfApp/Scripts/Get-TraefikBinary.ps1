...
$traefikPath = "/../ApplicationPackageRoot/TraefikServicePkg/Code/traefik.exe"
$treafikWatchdogPath = "/../ApplicationPackageRoot/WatchdogServicePkg/Code/traefik-appinsights-watchdog.exe"
